exports.config = {
  ...
  gherkin: {
    ...
    steps: ['./step_definitions/men_outerwear.js','./step_definitions/checkoutPage.js','./step_definitions/checkout-form/checkoutForm.js','./step_definitions/checkout-form/checkout-form-PP-80.js','./step_definitions/checkout-form/checkout-form-PP-98.js']
  },
  plugins: {
    screenshotOnFail: {
      enabled: true
